...
from .models import ( 
    ...
    ChallengeCategory, Challenge,UserChallengeAttempt, 
)
...
class ChallengeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Challenge
        fields = ['id', 'title', 'description', 'points', 'duration_days', 'start_date', 'end_date', 'is_active', 'level_name', 'category_name']
...
class UserChallengeAttemptSerializer(serializers.ModelSerializer):
    ...
    level = serializers.CharField(source='challenge.level.name', read_only=True)

    class Meta:
        model = UserChallengeAttempt
        fields = ['id', 'challenge', 'challenge_title', 'category_name', 'level', 'score', 'attempt_time']
        extra_kwargs = {'challenge': {'write_only': True}}
...
class YourRankingSerializer(serializers.Serializer):
